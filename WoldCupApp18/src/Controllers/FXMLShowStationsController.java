...
public class FXMLShowStationsController implements Initializable {
    ...
    private void deleteStation(ActionEvent event) throws SQLException {
        ...
        if (!table.getSelectionModel().isEmpty()) {
            ...
            alert.setHeaderText("Are you sure you want to delete this station : " + table.getSelectionModel().getSelectedItem().getSTATION_ID() + " ?");
            ...
            alert.setHeaderText("Would you select a station ! !");
            Optional<ButtonType> result = alert.showAndWait();
        }
    }
    ...
    private void UpdateStation(ActionEvent event) {
        ...
        if (!table.getSelectionModel().isEmpty()) {
            ...
            alert.setTitle("Update Station ");
            alert.setHeaderText("updating station :"
                    + table.getSelectionModel().getSelectedItem().getSTATION_NAME() + " done");
            Optional<ButtonType> result = alert.showAndWait();
